...
from lios import editor, imageview, ocr, preferences, train_tesseract
...
class linux_intelligent_ocr_solution():
	def __init__ (self,file_list=[]):
		...
		toolbar_iconview = containers.Toolbar(containers.Toolbar.HORIZONTAL,
			...
			(_("_Recognize"),self.ocr_selected_images),
		...
		[_("_Edit"),#(_("Undo"),self.textview.undo,"<Control>Z"),(_("Redo"),self.textview.redo,"<Control>Y"),
			...
			#menu.SEPARATOR,
			(_("Find"),self.textview.open_find_dialog,"<Control>F"),
		...
		#	],
		[_("Help"),
			(_("Open-Readme"),self.open_readme,"None"),
